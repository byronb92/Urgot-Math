...
import battle.actions.effects.BlackCleaverAfterAction;
 ...
 *
 */
public class BlackCleaverDynamic extends Item {
	...
	public void applyPassive(UrgotStats urgot) {
		this.urgot = urgot;
		BlackCleaverAfterAction cleaverStackPassive = new BlackCleaverAfterAction();
		urgot.addEffect(cleaverStackPassive);
		passiveApplied = true;
		setDetails();
	}
